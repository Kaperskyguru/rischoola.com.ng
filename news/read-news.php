                    ...
                    <div class="col-md-9">
                        ...
                        <div class="row">
                            <div class="col-md-12 pad-bottom-20">
                                ...
                                <h2></h2>
                                <?php
                                $stmt = $newsControler->get_post_comments_by_id('posts', $post_id);
                                if ($stmt->rowCount() > 0) {
                                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        <div class="commentlist">
                                            <ul>
                                                ...
                                                <!-- Replies -->
                                                <?php
                                                $stmt1 = $newsControler->get_replies_by_comment_id($comment_id);
                                                if ($stmt1->rowCount() > 0) {
                                                    while ($row1 = $stmt1->fetch(PDO::FETCH_ASSOC)) {
                                                        ...
                                                        <li class="replies" style="margin-left:15px">
                                                            <div class="comment-wrap ">
                                                                ...
                                                                <div class="author-comment">
                                                                    <cite class="fn">Posted by: <?php echo $newsControler->get_user_username_by_id($comment_user_id); ?></cite>
                                                                    <div class="">
