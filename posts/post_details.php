...
$id1 = $_GET['id'];
$id = intval($id1);
echo set_title($newsControler->get_post_title_by_id($id), get_site_name());
                ...
                <div class="text-left">
                    ...
                    <div class="pad-up-20">
                        <h6 style="color:#aaa; margin:8px;">
                            ...
                            <a style="text-decoration:none;" pid="<?php echo $post_id; ?>" href="<?php echo $url = get_user_uid() != null ? '#!' : "../users/login.php"; ?>" id="like_btn"> <span
                                    class="badge"
                                    id="like_span<?php echo $post_id; ?>"><?php echo $post_like_count; ?></span><span
                                    style="margin-right:8px">&nbsp;	<i class="fa fa-thumbs-up"></i></span></a>
                            <a style="text-decoration:none; color:red" pid="<?php echo $post_id; ?>" href="<?php echo $url = get_user_uid() != null ? '#!' : "../users/login.php"; ?>"
                                ...
                                <div class="commentlist">
                                    <ul>
                                        <div class="comment-wrap">
                                            ...
                                            <div class="like">
                                                <a rel="nofollow" class="comment-reply-link" href="#!" ><span class="fa fa-thumbs-up"></span>
                                                    Like <span class="badge">0</span>
                                                </a>
                                            </div>
                                            <div class="dislike">
                                                <a rel="nofollow" class="comment-reply-link" href="#"><span class="fa fa-thumbs-down"></span>
