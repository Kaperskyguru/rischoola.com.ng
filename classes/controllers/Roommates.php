...
class Roommates extends Logger
{
    ...
    public function display_if_room($schoolController, $lodgeController)
    {
        ...
        <div class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea rows="2" id="about_you" name="about_you" class="form-control"
                              placeholder="Tell your future roommate what you like, dislike or even more"></textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea rows="2" name="expectation" id="expectation" class="form-control"
                              placeholder="What kind of person do you want?"></textarea>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-8">
    ...
    public function display_no_room_form($schoolController, $lodgeController)
    {
        ...
        <form class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea rows="2" name="about_you" id="about_you" class="form-control"
                              placeholder="Tell your future roommate what you like, dislike or even more"></textarea>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-8">
                    <button type="button" id="submit_i_dont_have_a_room" name="submit_i_dont_have_a_room"
                            class="btn btn-danger">Make Request
                    </button>
